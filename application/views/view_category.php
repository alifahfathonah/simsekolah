...
<div class="banner-slider" style="background-image: url(<?php echo base_url(); ?>public/uploads/<?php echo $category['category_banner']; ?>)">
    ...
    <div class="bannder-table">
        <div class="banner-text">
            <h1><?php echo $CI->lang->line('CATEGORY'); ?>: <?php echo $category['category_name']; ?></h1>
        </div>
    </div>
</div>
<!--Banner End-->
                ...
                foreach($news_by_category as $row) {
                    ...
                    <div class="blog-one-item">
                        ...
                        <div class="blog-one-text">
                            ...
                            <div class="button-df">
                                <a href="<?php echo base_url(); ?>news/view/<?php echo $row['news_id']; ?>"><?php echo $CI->lang->line('READ_MORE'); ?> <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <?php
                ...
                <div class="sidebar">
                    <div class="sidebar-item">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="<?php echo $CI->lang->line('SEARCH_FOR'); ?>" name="search_string" autocomplete="off">
                    ...
                    <div class="sidebar-item">
                        <h3><?php echo $CI->lang->line('SIDEBAR_NEWS_HEADING_1'); ?></h3>
                        <ul>
                            <?php
                    ...
                    <div class="sidebar-item">
                        <h3><?php echo $CI->lang->line('SIDEBAR_NEWS_HEADING_2'); ?></h3>
                        <?php
                        $i=0;
