                ...
                <div class="col-lg-4 col-md-6">
                    <div class="services-item effect-item">
                        ...
                        <div class="services-text">
                            ...
                            <div class="button-bn">
                                <a href="<?php echo base_url(); ?>service/view/<?php echo $row['id']; ?>"><?php echo $CI->lang->line('READ_MORE'); ?> <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="portfolio-menu">
                    <ul id="filtrnav">
                        <li class="filtr filtr-active" data-filter="all"><?php echo $CI->lang->line('ALL'); ?></li>
                        <?php
                        ...
                        <form>
                            <div class="form-row row">
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control" placeholder="<?php echo $CI->lang->line('FIRST_NAME'); ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control" placeholder="<?php echo $CI->lang->line('LAST_NAME'); ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control" placeholder="<?php echo $CI->lang->line('PHONE_NUMBER'); ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control" placeholder="<?php echo $CI->lang->line('EMAIL_ADDRESS'); ?>">
                                </div>
                                <div class="form-group col-12">
                                    <input type="text" class="form-control" placeholder="<?php echo $CI->lang->line('ADDRESS'); ?>">
                                </div>
                                <div class="form-group col-12">
                                    <textarea class="form-control" placeholder="<?php echo $CI->lang->line('MESSAGE'); ?>"></textarea>
                                </div>

                                <div class="form-button col-12">
                                    <button type="submit" class="btn btn2"><?php echo $CI->lang->line('SUBMIT'); ?></button>
                                </div>
