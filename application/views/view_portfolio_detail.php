        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="portfolio-details-text">
                    <h3><?php echo $CI->lang->line('PROJECT_OVERVIEW'); ?></h3>
            ...
            <div class="col-lg-4">
                <div class="portfolio-sidebar">
                    <div class="portfolio-details headstyle">
                        <h4><?php echo $CI->lang->line('SIDEBAR_PORTFOLIO_HEADING_1'); ?></h4>
                        <ul>
                            <li><span><?php echo $CI->lang->line('CLIENT_NAME'); ?>:</span><br><?php echo $portfolio['client_name']; ?></li>
                            <li><span><?php echo $CI->lang->line('CLIENT_COMPANY_NAME'); ?>:<br></span><?php echo $portfolio['client_company']; ?></li>
                            <li><span><?php echo $CI->lang->line('PROJECT_START_DATE'); ?>:<br></span><?php echo $portfolio['start_date']; ?></li>
                            <li><span><?php echo $CI->lang->line('PROJECT_END_DATE'); ?>:<br></span><?php echo $portfolio['end_date']; ?></li>
                            <li><span><?php echo $CI->lang->line('CLIENT_COMMENT'); ?>:<br></span><?php echo $portfolio['client_comment']; ?></li>
                        </ul>
                    </div>
                    <div class="portfolio-form headstyle mt-30">
                        <h4><?php echo $CI->lang->line('SIDEBAR_PORTFOLIO_HEADING_2'); ?></h4>
                        <?php echo form_open(base_url().'portfolio/send_email',array('class' => '')); ?>
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    <input type="phone" class="form-control" placeholder="<?php echo $CI->lang->line('PHONE_NUMBER'); ?>" name="phone" required>
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="<?php echo $CI->lang->line('MESSAGE'); ?>" name="message" required></textarea>
                                </div>
                                <div class="form-button">
                                    <button type="submit" class="btn" name="form_portfolio"><?php echo $CI->lang->line('SUBMIT'); ?></button>
                                </div>
                            </div>
                        <?php echo form_close(); ?>
                    </div>
...
<div class="recent-project bg-area pt_90 pb_90">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="headline">
                    <h2><?php echo $CI->lang->line('RECENT_PORTFOLIO'); ?></h2>
                    <h3><?php echo $CI->lang->line('RECENT_PORTFOLIO_SUBTITLE'); ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
