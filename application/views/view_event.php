                            ...
                            <div class="col-xl-9 col-lg-8">
                                <div class="event-body">
                                    <div class="event-header">
                                        <ul>
                                            <li class="event-header-left">
                                                ...
                                                <span><i class="fa fa-clock-o"></i> <?php echo $CI->lang->line('START_DATE'); ?>: 
                                                <?php 
                                                ...
                                                <span><i class="fa fa-clock-o"></i> <?php echo $CI->lang->line('END_DATE'); ?>: 
                                                <?php 
                                            ...
                                            <li class="event-header-left">
                                                <span><i class="fa fa-map-marker"></i> <?php echo $CI->lang->line('ADDRESS'); ?>: <?php echo nl2br($row->event_location); ?></span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="event-content">
                                        ...
                                        <div class="button-df">
                                            <a href="<?php echo base_url(); ?>event/view/<?php echo $row->event_id; ?>"><?php echo $CI->lang->line('READ_MORE'); ?> <i class="fa fa-chevron-circle-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
