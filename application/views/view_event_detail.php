        ...
        <div class="row">
            <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="event-contact-item">
                                ...
                                <div class="event-contact-text">
                                    <h4><?php echo $CI->lang->line('EVENT_START_DATE'); ?></h4>
                                    <p>
                                        <?php 
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="event-contact-item">
                                ...
                                <div class="event-contact-text">
                                    <h4><?php echo $CI->lang->line('EVENT_END_DATE'); ?></h4>
                                    <p>
                                        <?php 
                ...
                <div class="event-map headstyle">
                    <h4><?php echo $CI->lang->line('EVENT_LOCATION_MAP'); ?></h4>
                    <?php echo $event_detail['event_map']; ?>
                </div>
                <div class="comment-form headstyle mt_50">
                    <h4><?php echo $CI->lang->line('SHARE_THIS_EVENT'); ?></h4>
            ...
            <div class="col-lg-4">
                <div class="event-sidebar sidebar">
                    <div class="sidebar-item">
                        <h3><?php echo $CI->lang->line('SIDEBAR_EVENT_HEADING_1'); ?></h3>
                        <?php
                        $i=0;
                        foreach($event as $row) {
                            ...
                            <div class="sidebar-recent-item">
                                ...
                                <div class="recent-text">
                                    ...
                                    <div class="rpwwt-post-date"><?php echo $CI->lang->line('START_DATE'); ?>: <?php echo $row['event_start_date']; ?></div>
                                </div>
                            </div>
                            <?php endif; ?>
                            <?php
                    ...
                    <div class="sidebar-item">
                        <h3><?php echo $CI->lang->line('SIDEBAR_EVENT_HEADING_2'); ?></h3>
                        <?php
                        $i=0;
                        foreach($event as $row) {
                            $i++;
