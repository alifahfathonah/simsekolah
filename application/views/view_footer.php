        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-12">
                    <div class="button">
                        <a href="<?php echo $setting['cta_button_url']; ?>"><?php echo $CI->lang->line('FOOTER_CTA_BUTTON'); ?> <i class="fa fa-chevron-circle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item" id="newsletter">
                        <h3><?php echo $CI->lang->line('FOOTER_1_HEADING'); ?></h3>
                        <p>
                            <?php echo nl2br($setting['newsletter_text']); ?>
                        </p>
                        <?php echo form_open(base_url().'newsletter/send',array('class' => '')); ?>
                        <div class="input-group">                            
                            <input type="email" class="form-control" placeholder="<?php echo $CI->lang->line('EMAIL_ADDRESS'); ?>" name="email_subscribe" required>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        <h3><?php echo $CI->lang->line('FOOTER_2_HEADING'); ?></h3>
                        <ul>
                            <?php
                            $i=0;
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        <h3><?php echo $CI->lang->line('FOOTER_3_HEADING'); ?></h3>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        <h3><?php echo $CI->lang->line('FOOTER_4_HEADING'); ?></h3>
                ...
                <div class="col-12">
                    <div class="footer-menu">
                        <ul>
                            ...
                            <li><a href="<?php echo base_url(); ?>terms-and-conditions"><?php echo $CI->lang->line('TERMS_AND_CONDITIONS'); ?></a></li>
                            <li><a href="<?php echo base_url(); ?>privacy-policy"><?php echo $CI->lang->line('PRIVACY_POLICY'); ?></a></li>
                        </ul>
                    </div>
                    <div class="copy-text">
                        <p>
