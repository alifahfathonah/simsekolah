...
<section class="content-header">
  ...
  <button class="btn btn-danger btn-sm" type="button">Export PDF</button>
    <button class="btn btn-warning btn-sm" type="button">Export PDF (+Cover)</button>
    <button class="btn btn-primary btn-sm" id="generateNilaiRaport" type="button">Generate</button>
    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <div class="box-body table-responsive">
          <table id="nilaiRaport" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th>#</th>
                <th>Nama</th>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
                ...
                <div class="row m-3">
						...
						echo form_open_multipart(base_url('admin/raport/pilihFile'),$attr) ?>
