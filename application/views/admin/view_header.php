	...
	<div class="wrapper">
		<header class="main-header">
			<a href="<?php echo base_url(); ?>admin/dashboard" class="logo">
				<span class="logo-lg">SIM Sekolah</span>
			</a>
			...
			<section class="sidebar">
				<ul class="sidebar-menu">
					...
					<?php if( $this->session->userdata('role') == 'Admin' ): ?>
						<li class="treeview <?php if( ($class_name == 'tahun_ajar') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/tahun_ajar">
								<i class="fa fa-calendar"></i> <span>Tahun Ajaran</span>
							</a>
						</li>

						<li class="treeview <?php if( ($class_name == 'kelas') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/kelas">
								<i class="fa fa-list"></i> <span>Kelas</span>
							</a>
						</li>

						<li class="treeview <?php if( ($class_name == 'siswa') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/siswa">
								<i class="fa fa-user"></i> <span>Siswa</span>
							</a>
						</li>

						<li class="treeview <?php if( ($class_name == 'mutasi') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/mutasi">
								<i class="fa fa-refresh"></i> <span>Mutasi</span>
							</a>
						</li>
						<hr>

						<li class="treeview <?php if( ($class_name == 'guru') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/guru">
								<i class="fa fa-group"></i> <span>Guru</span>
							</a>
						</li>

						<li class="treeview <?php if( ($class_name == 'wali_kelas') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/wali_kelas">
								<i class="fa fa-gratipay"></i> <span>Wali Kelas</span>
							</a>
						</li>

						<li class="treeview <?php if( ($class_name == 'mapel') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/mapel">
								<i class="fa fa-book"></i> <span>Mata Pelajaran</span>
							</a>
						</li>

						<li class="treeview <?php if( ($class_name == 'kd') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/kd">
								<i class="fa fa-book"></i> <span>KD Pelajaran</span>
							</a>
						</li>

						<li class="treeview <?php if( ($class_name == 'guru_mapel') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/guru_mapel">
								<i class="fa fa-child"></i> <span>Guru Mapel</span>
							</a>
						</li>
<hr>
						<li class="treeview <?php if( ($class_name == 'nilaikd') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/nilaikd">
								<i class="fa fa-file-text"></i> <span>Nilai KD</span>
							</a>
						</li>

						<li class="treeview <?php if( ($class_name == 'raport') ) {echo 'active';} ?>">
							<a href="<?php echo base_url(); ?>admin/raport">
