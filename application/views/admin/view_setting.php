    ...
    <div class="col-md-12">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          ...
          <li><a href="#tab_admin" data-toggle="tab">Admin Login</a></li>
        </ul>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab_admin">
            ...
            <div class="box box-info">
              <div class="box-body">
                <div class="form-group">
                  <label for="" class="col-sm-2 control-label">Login Page Heading </label>
                  <div class="col-sm-4">
                    <input type="text" name="admin_login_heading" class="form-control" value="<?php echo $setting['admin_login_heading']; ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="" class="col-sm-2 control-label"></label>
                  <div class="col-sm-6">
                    <button type="submit" class="btn btn-success pull-left" name="form_admin">Update</button>
                  </div>
                </div>
              </div>
            </div>
